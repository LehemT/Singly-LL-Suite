 ...
 * This file contains the main functions that runs various tests on the 
 * linked list functions. It tests adding elements, manipulating nodes, 
 * and counting specific values within the list.
*/
...
int main(void)
{
    printf("Running test harness for Singly-LL Suite\n\n");
